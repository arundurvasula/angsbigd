...
command1="-bam data/"$taxon"_list.txt -out temp/"$taxon" -doMajorMinor 1 -doMaf 1 -indF data/$taxon.indF -doSaf 1 -uniqueOnly 0 -anc data/TRIP.fa.gz -minMapQ $minMapQ -minQ 20 -nInd $nInd -minInd $minInd -baq 1 -ref /home/adurvasu/genomes/Zea_mays.AGPv3.21.dna.genome.fa.gz -GL $glikehood -P $cpu  $range"
echo $command1
